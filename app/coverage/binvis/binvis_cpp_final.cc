/// Final C++ version of binvis - generates identical output to the original
/// This version uses the same logic as the original C code
...
class GroupVisCppFinal : public UcapiVisitor {
private:
    bool _warned;
...
public:
    GroupVisCppFinal(covdbHandle design) : UcapiVisitor(design) {
        _warned = false;
    }
    virtual ~GroupVisCppFinal() { }
